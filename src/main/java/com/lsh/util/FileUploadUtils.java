...
import com.lsh.exception.file.FileNameLengthLimitExceededException;
import com.lsh.exception.file.FileSizeLimitExceededException;
import com.lsh.exception.file.InvalidExtensionException;
import com.lsh.util.uuid.Seq;
...
public class FileUploadUtils {
     ...
     * 默认大小 50M
     */
    public final long DEFAULT_MAX_SIZE = 50 * 1024 * 1024;

    /**
     * 默认的文件名最大长度 100
     */
    public final int DEFAULT_FILE_NAME_LENGTH = 100;
     ...
     * 默认上传的地址
     */
    public String defaultBaseDir = "./data";
