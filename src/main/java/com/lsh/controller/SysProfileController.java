...
import com.lsh.util.FileUploadUtils;
import com.lsh.util.MimeTypeUtils;
...
public class SysProfileController extends BaseController {
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception {
        if (!file.isEmpty()) {
            LoginUser loginUser = getLoginUser();
            String avatar = fileUploadUtils.upload(oaSystemConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
