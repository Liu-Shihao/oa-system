...
import com.lsh.domain.entity.SysUserRole;
...
public class ISysUserServiceImpl implements ISysUserService{
    ...
    {
        return sysUserRepository.selectUserList(user);
    }
    ...
    {
        List<SysPost> list = sysPostRepository.selectPostsByUserName(userName);
        if (CollectionUtils.isEmpty(list))
        {
            return StringUtils.EMPTY;
        }
    ...
    public boolean checkUserNameUnique(SysUser user)
    {
        ...
        SysUser info = sysUserRepository.checkUserNameUnique(user.getUserName());
    ...
    {
        Long userId = StringUtils.isNull(user.getUserId()) ? -1L : user.getUserId();
        SysUser info = sysUserRepository.checkPhoneUnique(user.getPhonenumber());
        if (StringUtils.isNotNull(info) && info.getUserId().longValue() != userId.longValue())
        {
            return UserConstants.NOT_UNIQUE;
        }
    ...
    {
        Long userId = StringUtils.isNull(user.getUserId()) ? -1L : user.getUserId();
        SysUser info = sysUserRepository.checkEmailUnique(user.getEmail());
        if (StringUtils.isNotNull(info) && info.getUserId().longValue() != userId.longValue())
        {
            return UserConstants.NOT_UNIQUE;
        }
    ...
    {
        return sysUserRepository.insertUser(user) > 0;
    }
    ...
    public void insertUserPost(SysUser user)
    {
        ...
        if (StringUtils.isNotEmpty(posts))
        {
            ...
            sysUserPostRepository.batchUserPost(list);
        }
    }
    ...
    public void insertUserRole(Long userId, Long[] roleIds)
    {
        if (StringUtils.isNotEmpty(roleIds))
        {
            ...
            sysUserRoleRepository.batchUserRole(list);
        }
    }
    ...
    public int deleteUserById(Long userId)
    {
        ...
        // 删除用户与岗位表
        sysUserPostRepository.deleteUserPostByUserId(userId);
        return sysUserRepository.deleteUserById(userId);
    }
    ...
    public int deleteUserByIds(Long[] userIds)
    {
        ...
        // 删除用户与角色关联
        sysUserRoleRepository.deleteUserRole(userIds);
        // 删除用户与岗位关联
        sysUserPostRepository.deleteUserPost(userIds);
    ...
    public String importUser(List<SysUser> userList, Boolean isUpdateSupport, String operName)
    {
        ...
        for (SysUser user : userList)
        {
            ...
            {
                // 验证是否存在这个用户
                SysUser u = sysUserRepository.selectUserByUserName(user.getUserName());
